...
void loadTable() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String harga = String.valueOf(rs.getInt("harga_avg"));
                tbl.addRow(new Object[]{false, no++, id, nama, stok, harga});
...
private void initSearch() {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        if(table.getSelectedRow() != -1) {
            ...
            ID = tbl.getValueAt(table.getSelectedRow(), 2).toString();
        }
