...
public class Form_Transaksi extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        kode7 = new javax.swing.JLabel();
        totalakhirText = new javax.swing.JTextField();
        diskonText = new javax.swing.JTextField();
        kode8 = new javax.swing.JLabel();
        ...
        kode7.setFont(new java.awt.Font("SansSerif", 1, 13)); // NOI18N
        kode7.setText("Diskon");

        totalakhirText.setEditable(false);
        totalakhirText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                totalakhirTextActionPerformed(evt);
            }
        });

        diskonText.setEditable(false);
        diskonText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                diskonTextActionPerformed(evt);
            }
        });

        kode8.setFont(new java.awt.Font("SansSerif", 1, 13)); // NOI18N
        kode8.setText("Total Akhir");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(diskonText, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(0, 0, Short.MAX_VALUE)
                                        .addComponent(kode8)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(totalakhirText, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(49, 49, 49)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButton4)
                    .addComponent(kode7)
                    .addComponent(diskonText, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(kode4)
                    ...
                    .addComponent(totalakhirText, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(kode8))
    ...
    public File generateStrukPDF(
        ...
        document.add(rowtot);
         PdfPTable rowdis = alignKiriKanan("Diskon", "Rp. " + formatRupiah(diskon), normal, normal, totalLebarTabel);
        document.add(rowdis);
         PdfPTable rowak = alignKiriKanan("Total Akhir", "Rp. " + formatRupiah(total_akhir), normal, normal, totalLebarTabel);
        document.add(rowak);
        PdfPTable rowbay = alignKiriKanan("Bayar (cash)", "Rp. " + formatRupiah(bayar), normal, normal, totalLebarTabel);
        document.add(rowbay);
        PdfPTable rowkem = alignKiriKanan("Kmebalian (cash)", "Rp. " + formatRupiah(kembali), normal, normal, totalLebarTabel);
        document.add(rowkem);
...
//    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try{
            ...
            if (rs.next()) {
                ...
                String checkDiskon = "select count(*) as jumlah from transaksi where id_pelanggan = '"+ id +"'";
                ResultSet rs2 = DatabaseConnection.getData(checkDiskon);
                if(rs2.next()){
                    int jumlah = rs2.getInt("jumlah");
                
                    String ambildiskon = "select jumlah_diskon from diskon where syarat_jumlah_diskon="+ jumlah + "";
                    ResultSet rs3 = DatabaseConnection.getData(ambildiskon);

                    if(rs3.next()){
                        int jumlahdiskon = rs3.getInt("jumlah_diskon");
                        diskonText.setText(String.valueOf(jumlahdiskon));
                        int total_akhir = Integer.valueOf(hargaText.getText()) - jumlahdiskon;
                        totalakhirText.setText(String.valueOf(total_akhir));
                    }else{
                        diskonText.setText("0");
                        totalakhirText.setText(hargaText.getText());
                    }
                }
    ...
    private void bayarTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bayarTextActionPerformed
        if(Integer.valueOf(totalakhirText.getText()) <= Integer.valueOf(bayarText.getText())){
            int a = Integer.valueOf(bayarText.getText()) - Integer.valueOf(totalakhirText.getText());
            kembalianText.setText(String.valueOf(a));
        }else{
            JOptionPane.showMessageDialog(this, "Duit Kurang");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(Integer.valueOf(hargaText.getText()) > Integer.valueOf(bayarText.getText())) {
            ...
            try {
                ...
                String insertTransaksiQuery = "INSERT INTO transaksi (kode, id_pelanggan, tanggal, status, total, diskon, total_akhir, pembayaran, kembalian) " +
                              "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                transaksiPs.setInt(5, Integer.valueOf(hargaText.getText()));
                transaksiPs.setInt(6, Integer.valueOf(diskonText.getText()));
                transaksiPs.setInt(7, Integer.valueOf(totalakhirText.getText()));
                transaksiPs.setInt(8, Integer.valueOf(bayarText.getText()));
                transaksiPs.setInt(9, Integer.valueOf(kembalianText.getText()));
                ...
                int diskon = Integer.valueOf(diskonText.getText());
                int total_akhir = Integer.valueOf(totalakhirText.getText());
                ...
                ThermalPrinterUtil.printToThermalPrinter(pdf, "POS-80");
    ...
    private void totalakhirTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_totalakhirTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_totalakhirTextActionPerformed

    private void diskonTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_diskonTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_diskonTextActionPerformed
    ...
    private javax.swing.JLabel kode7;
    private javax.swing.JLabel kode8;
    private javax.swing.JComboBox<String> layananText;
    private javax.swing.JTextField namaText;
    private javax.swing.JTextField nohpText;
    private javax.swing.JTextField qtyText;
    private javax.swing.JScrollPane scroll;
    private javax.swing.JTextField totalakhirText;
