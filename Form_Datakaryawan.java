...
public class Form_Datakaryawan extends javax.swing.JPanel {
   ...
   private CreateKaryawan CreateKaryawan;
    ...
    try {
        ...
        while (rs.next()) {
            ...
            switch (role) {
                ...
                default: role = "Karyawan"; break;
            }

            // Tambahkan baris ke tabel model
            tbl.addRow(new Object[]{false, no++, id, nama, username, password, role, rfid});
        }

        // Setelah data dimasukkan, baru set model ke table
...
private void initSearch() {
    ...
    private void cmdEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdEditActionPerformed
        ...
        if (selectedRow != -1) {
            String selectedId = Maintable.getValueAt(selectedRow, 2).toString(); // Kolom ID
            String nama       = Maintable.getValueAt(selectedRow, 3).toString(); // Kolom NAMA
            String user       = Maintable.getValueAt(selectedRow, 4).toString(); // Kolom USER
            String pass       = Maintable.getValueAt(selectedRow, 5).toString(); // Kolom PASS
            String role       = Maintable.getValueAt(selectedRow, 6).toString(); // Kolom ROLE
            String rfid       = Maintable.getValueAt(selectedRow, 7).toString(); // Kolom RFID

            createPanel.setEditMode(true);
            createPanel.setSelectedId(selectedId);  
            createPanel.setName(nama);
            createPanel.setUsername(user);
            createPanel.setPassword(pass);
            createPanel.setRole(role);
            createPanel.setRFID(rfid);
    ...
    private void MaintableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MaintableMouseClicked
        if(Maintable.getSelectedRow() != -1) {
            ...
            ID = tbl.getValueAt(Maintable.getSelectedRow(), 2).toString();
        }
